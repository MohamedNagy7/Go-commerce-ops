...
// Idempotent — same guarantee as the Nest setupTopology. Safe to call on
// every boot; declaring something that already exists with the same
// properties is a no-op.
